...
BEGIN
	...
	Writeln('-d Decipher, optionally followed by ciphertext in double quotes.');
	Writeln('-e Encipher, optionally followed by plaintext  in double quotes.');
	...
	Writeln('-g Groups. Default 4 letters. Optionally set with number after -g.');
	...
	Writeln('-m Modulo mode of ASCII set: 1=26, 2=95, 3=128, 4=256.');
	Writeln('-o Filename of a true one-time pad from a source such as Random.org.');
	Writeln('-v Verbose. Show output from each stage of the encryption and decryption.');
	Writeln;
